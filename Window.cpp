...
void Window::updateUniformBuffer(uint32_t currentImage) {
    ...
    void* data;
    vkMapMemory(m_device->m_device, m_uniformBuffers[currentImage].m_bufferMemory, 0, sizeof(ubo), 0, &data);
        memcpy(data, &ubo, sizeof(ubo));
    vkUnmapMemory(m_device->m_device, m_uniformBuffers[currentImage].m_bufferMemory);
}
